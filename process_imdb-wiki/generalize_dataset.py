...
cols = ['path', 'age', 'gender', 'face_score1', 'face_score2']
...
for n in range(len(imdb_gender)):
    if imdb_gender[n] == 1:
        imdb_genders.append(0)  #male: lable-0
    else:
        imdb_genders.append(1) #female: label-1
...
final_imdb = np.vstack((imdb_path, imdb_age, imdb_genders, imdb_face_score1, imdb_face_score2)).T
final_wiki = np.vstack((wiki_path, wiki_age, wiki_genders, wiki_face_score1, wiki_face_score2)).T
