...
__all__ = ['ResNet', 'cc_irse_facenet18', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152']
...
def cc_irse_facenet18(use_se=True, **kwargs):
    model = ResNet(IRBlock, [2, 2, 2, 2], use_se=use_se, **kwargs)
    return model

'''
def cc_resface18(use_se=True, **kwargs):
    model = ResNet(IRBlock, [2, 2, 2, 2], use_se=use_se, **kwargs)
    return model
'''
...
def cc_resface12(use_se=True, **kwargs):
    model = ResNet(IRBlock, [1, 1, 2, 1], use_se=use_se, **kwargs)
    return model

def cc_facenet101(use_se=True, **kwargs):
